package com.programming.innerclasschallenge;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Album album = new Album("StormBringer", "Deep purble");
        album.addSong("StormBringer", 4.6);
        album.addSong("love don't mean a thing", 4.2);
        album.addSong("Holy man", 4.3);
        album.addSong("Hold on", 3.6);
        album.addSong("lady duble dealer", 6.6);
        album.addSong("you can't do it right", 4.26);
